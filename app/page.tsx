...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-black text-white font-mono uppercase">
      {/* BANNER ATAS - BERSIH DARI SIMBOL >> DAN << */}
      <div className="bg-[#00ff00] text-black p-2 font-black flex justify-between sticky top-0 z-50 text-[10px]">
      ...
      <div className="p-4 space-y-4">
        <div className="flex justify-between items-end border-b border-[#00ff00]/20 pb-4">
          ...
          <div className="text-[8px] text-zinc-500 font-bold tracking-widest">VER 12.0.4</div>
        </div>
        ...
        <div className="flex flex-col gap-3">
          {sorted.map((coin) => {
            ...
            return (
              <div key={coin.symbol} className={`p-5 border transition-all duration-500 ${moving ? 'bg-[#081a08] border-[#00ff00] scale-[1.02] shadow-lg' : 'bg-black border-zinc-800 opacity-40'}`}>
                ...
                <div className="grid grid-cols-3 gap-2 border-t border-zinc-800 pt-4 text-center">
                  ...
                  <div>
                    ...
                    <p className="text-lg font-black text-white">{d.change?.toFixed(2)}%</p>
                  </div>
                  <div>
